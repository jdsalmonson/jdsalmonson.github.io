...
where the incident force is the applied minus drag force, $$ F_i \equiv F_a - F_d $$ and $$F_f$$ if the (static or kinetic) friction force of the object.  The right-hand side of the first two equations is determined by whether the finger and object are separate or touching.
